...
describe('sessionsRepository', () => {
  ...
  /*
   * SESSIONS PER DAY TESTS
   * Verify daily session aggregation for analytics
   */
  describe('sessionsPerDay', () => {
    it('should return empty array when no sessions exist for project', () => {
      const result = sessionsRepository.sessionsPerDay(TEST_PROJECT_ID)
    ...
    it('should count sessions grouped by day', () => {
      ...
      const result = sessionsRepository.sessionsPerDay(TEST_PROJECT_ID, 365)
    ...
    it('should respect the days parameter', () => {
      ...
      const last30 = sessionsRepository.sessionsPerDay(TEST_PROJECT_ID, 30)
      const last90 = sessionsRepository.sessionsPerDay(TEST_PROJECT_ID, 90)

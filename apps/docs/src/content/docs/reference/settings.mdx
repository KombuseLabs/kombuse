...
import screenshotActiveAgentsIndicator from '../../../assets/quickstart/first-ticket-planning-active.png';
...
The **Sidebar** card has five toggles that control which experimental sections appear in the project sidebar. All default to off:
...
> **Experimental:** These pages are under active development and will change significantly in future releases.
...
<WindowFrame title="Kombuse">
  <Image src={screenshotActiveAgentsIndicator} alt="The Active Agents indicator showing the Planning Agent working on the ticket" />
</WindowFrame>

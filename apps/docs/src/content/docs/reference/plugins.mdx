...
The Plugins page is an experimental feature hidden from the sidebar by default. To enable it, open **Settings**, select the **General** tab, and locate the **Sidebar** section. Turning on the **Show Plugins** toggle adds a Plugins link to the project sidebar navigation.
...
- [Building a Plugin](/guides/building-a-plugin) — create, export, and share reusable plugin packages

...
Triggers determine when the agent runs automatically. The code review agent is configured with two triggers on the **Configuration** tab of the agent detail page, in the **Triggers** section (lightning bolt icon).

...
import screenshotPluginsPage from '../../../assets/building-a-plugin/plugins-page.png';
import screenshotExportDialog from '../../../assets/building-a-plugin/export-dialog.png';
import screenshotPluginDetail from '../../../assets/building-a-plugin/plugin-detail.png';
...
<WindowFrame title="Kombuse">
  <Image src={screenshotPluginsPage} alt="The Plugins page showing installed plugins with version and source badges" />
</WindowFrame>
...
<WindowFrame title="Kombuse">
  <Image src={screenshotExportDialog} alt="The Export Plugin dialog with package name, description, agent selection, and included labels" />
</WindowFrame>
...
<WindowFrame title="Kombuse">
  <Image src={screenshotPluginDetail} alt="An installed plugin showing its bundled agents and labels" />
</WindowFrame>

## See also

- [Agent Permissions](/reference/agent-permissions) — control what resources and tools agents can access
- [Plugins](/reference/plugins) — browse, install, and manage plugin packages
- [Using Kombuse from MCP-Enabled Tools](/guides/claude-code) — connect external AI tools to Kombuse

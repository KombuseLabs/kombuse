...
Navigate to **Agents** in the project sidebar and click **Install kombuse/kombuse-dev** to get started. Once installed, the Agents page lists all available agents with their names and descriptions.
